...
public class Verify {
    ...
    @Test
    public void reactionParserTest() {
        ...
        // 10 ORE -> 10 A
        Assert.assertEquals(10, reactions.get(0).getOutput().getAmount());
        Assert.assertEquals("A", reactions.get(0).getOutput().getName());

        Assert.assertEquals(10, reactions.get(0).getInput().get(0).getAmount());
        Assert.assertEquals("ORE", reactions.get(0).getInput().get(0).getName());


        // 1 ORE -> 1 B
        Assert.assertEquals(1, reactions.get(1).getOutput().getAmount());
        Assert.assertEquals("B", reactions.get(1).getOutput().getName());

        Assert.assertEquals(1, reactions.get(1).getInput().get(0).getAmount());
        Assert.assertEquals("ORE", reactions.get(1).getInput().get(0).getName());


        // 7 A, 1 B => 1 C
        Assert.assertEquals(1, reactions.get(2).getOutput().getAmount());
        Assert.assertEquals("C", reactions.get(2).getOutput().getName());

        Assert.assertEquals(7, reactions.get(2).getInput().get(0).getAmount());
        Assert.assertEquals("A", reactions.get(2).getInput().get(0).getName());
        Assert.assertEquals(1, reactions.get(2).getInput().get(1).getAmount());
        Assert.assertEquals("B", reactions.get(2).getInput().get(1).getName());
    }

    @Test
    public void reactionOneTest() {
        String input = "10 ORE => 10 A\n" +
                "1 ORE => 1 B\n" +
                "7 A, 1 B => 1 C\n" +
                "7 A, 1 C => 1 D\n" +
